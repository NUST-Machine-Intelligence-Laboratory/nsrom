...
class VGG(nn.Module):
    ...
    def forward(self, x, epoch=1, label=None, img_name=None):
        x = self.features(x)
        ...
        if img_name != None and epoch > 0:
            ...
            for i in range(ind.shape[0]):
                ...
                img_name_temp = img_name[batch_index].strip().split('/')[-1]
                img_name_temp = img_name_temp.split('.')[0]
                accu_map_name = '{}/{}_{}.png'.format(self.att_dir, img_name_temp, la)
